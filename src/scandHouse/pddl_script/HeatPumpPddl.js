const pddlActionIntention = require('../pddl/actions/pddlActionIntention')
    ...
    class setTempHigh extends Check {
        ...
        static precondition = [ ['heatpump', 'obj'], ['solarpanel', 'obj2'], ['carcharger', 'obj3'], ['window', 'obj4'], ['awake', 'obj2'], ['notawake', 'obj3'], ['notopen', 'obj4'], ['switch_on', 'obj'], ['temp_low', 'obj'] ];
        static effect = [ ['temp_high', 'obj'] ];
        *exec ({obj}=parameters) {
            yield this.checkPreconditionAndApplyEffect(), this.agent.highTemp();
    ...
    class setTempLow extends Check {
        ...
        *exec ({obj}=parameters) {
            yield this.checkPreconditionAndApplyEffect(), this.agent.lowTemp();
